    ...
    public sealed class CollectionGameViewModel : ViewModelBase
    {
        public CollectionGameViewModel(IAppNavigationService nav, ItemCategory subCategory)
        {
            ...
            EditSelectedItem = new CustomCommand(
                ...
                (x) =>
                {
                    Nav.Navigate(() => ItemGamePage.ExistingGamePage(SelectedItem.Id));
                },
            ...
            CurrentPage = new ObservableCollection<VideoGame>();
        ...
        public ObservableCollection<VideoGame> CurrentPage
        {
            get;
            private set;
        }

        public VideoGame SelectedItem
        {
            get
            {
                return selectedItem;
        ...
        private void RefreshSearch()
        {
            ...
            foreach (VideoGame result in currentSearch.CurrentPage)
            {
        ...
        private Search<VideoGame> currentSearch;
        private VideoGame selectedItem;
